...
def bari2d():
    ...
    e ='death'
    t = 'deathfu'
    outcome_ = outcome[[e, t]].rename(columns={e:'event', t:'time'})
    outcome_['time'] /= 365.25
    ...
    model = phenotyping(outcome_, dataset_raw.loc[outcome_.index][cat_feats + num_feats], intervention.loc[outcome_.index], cat_feats, num_feats,
                        all_in_one=False, name='Bari2D')
